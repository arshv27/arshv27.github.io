...
My experience covers the full ML lifecycle: data ingestion and engineering, model training, alignment, evaluation, and production deployment. I have depth in deep learning, reinforcement learning, LLMs, and agent-based systems, and I move comfortably between modeling, infrastructure, and product to ship AI systems that are scalable and reliable. I am equally at home with customers and stakeholders: scoping problems with them, aligning technical decisions with their goals, and seeing the work through to deployment. I take end-to-end ownership, move quickly from idea to execution, and do my best work in fast-paced, high-ownership environments where engineering decisions directly shape impact.
